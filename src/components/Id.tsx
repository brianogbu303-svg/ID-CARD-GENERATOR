...
const Id = () => {
  ...
  return (
    <div className="p-12 grid w-2xl ml-4 max-[400px]:scale-[0.6] items-center">
      ...
      <button
        ...
        className="bg-green-500  text-white p-2 max-[400px]:scale-[0.6] rounded mt-4 hover:bg-green-600"
        >
        Download ID
      </button>
    </div>
